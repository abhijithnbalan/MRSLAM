...
(cl:defmethod cl:initialize-instance :after ((m <AppUnload-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AppUnload-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name app_loader-srv:<AppUnload-request> is deprecated: use app_loader-srv:AppUnload-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <AppUnload-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader app_loader-srv:name-val is deprecated.  Use app_loader-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <AppUnload-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader app_loader-srv:type-val is deprecated.  Use app_loader-srv:type instead.")
  (type m))
...
(cl:defmethod cl:initialize-instance :after ((m <AppUnload-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AppUnload-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name app_loader-srv:<AppUnload-response> is deprecated: use app_loader-srv:AppUnload-response instead.")))
