...
(cl:defmethod cl:initialize-instance :after ((m <AppLoad-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AppLoad-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name app_loader-srv:<AppLoad-request> is deprecated: use app_loader-srv:AppLoad-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <AppLoad-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AppLoad-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name app_loader-srv:<AppLoad-response> is deprecated: use app_loader-srv:AppLoad-response instead.")))
