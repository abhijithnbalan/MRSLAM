...
(cl:defclass <SCDSPSOPut> (roslisp-msg-protocol:ros-message)
  ((key
    :reader key
    :initarg :key
    :type cl:string
...
(cl:defclass SCDSPSOPut (<SCDSPSOPut>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SCDSPSOPut>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SCDSPSOPut)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gsdf_msgs-msg:<SCDSPSOPut> is deprecated: use gsdf_msgs-msg:SCDSPSOPut instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <SCDSPSOPut>))
...
(cl:defmethod pos-val ((m <SCDSPSOPut>))
...
(cl:defmethod val-val ((m <SCDSPSOPut>))
...
(cl:defmethod robot_id-val ((m <SCDSPSOPut>))
...
(cl:defmethod gen-val ((m <SCDSPSOPut>))
...
(cl:defmethod timestamp-val ((m <SCDSPSOPut>))
  ...
  (timestamp m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SCDSPSOPut>) ostream)
  "Serializes a message object of type '<SCDSPSOPut>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SCDSPSOPut>) istream)
  "Deserializes a message object of type '<SCDSPSOPut>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SCDSPSOPut>)))
  "Returns string type for a message object of type '<SCDSPSOPut>"
  "gsdf_msgs/SCDSPSOPut")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SCDSPSOPut)))
  "Returns string type for a message object of type 'SCDSPSOPut"
  "gsdf_msgs/SCDSPSOPut")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SCDSPSOPut>)))
  "Returns md5sum for a message object of type '<SCDSPSOPut>"
  "4df795d490b81d6e66669b482531c966")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SCDSPSOPut)))
  "Returns md5sum for a message object of type 'SCDSPSOPut"
  "4df795d490b81d6e66669b482531c966")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SCDSPSOPut>)))
  "Returns full string definition for message of type '<SCDSPSOPut>"
  (cl:format cl:nil "string key~%float32[] pos~%float32 val~%int32 robot_id~%int32 gen~%int32 timestamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SCDSPSOPut)))
  "Returns full string definition for message of type 'SCDSPSOPut"
  (cl:format cl:nil "string key~%float32[] pos~%float32 val~%int32 robot_id~%int32 gen~%int32 timestamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SCDSPSOPut>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SCDSPSOPut>))
