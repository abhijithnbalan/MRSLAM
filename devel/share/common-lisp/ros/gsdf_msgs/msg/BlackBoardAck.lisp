...
;//! \htmlinclude BlackBoardAck.msg.html

(cl:defclass <BlackBoardAck> (roslisp-msg-protocol:ros-message)
  ((bb_id
    :reader bb_id
    :initarg :bb_id
    :type cl:integer
...
(cl:defclass BlackBoardAck (<BlackBoardAck>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <BlackBoardAck>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'BlackBoardAck)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gsdf_msgs-msg:<BlackBoardAck> is deprecated: use gsdf_msgs-msg:BlackBoardAck instead.")))

(cl:ensure-generic-function 'bb_id-val :lambda-list '(m))
(cl:defmethod bb_id-val ((m <BlackBoardAck>))
...
(cl:defmethod on_robot_id-val ((m <BlackBoardAck>))
...
(cl:defmethod key-val ((m <BlackBoardAck>))
...
(cl:defmethod value-val ((m <BlackBoardAck>))
...
(cl:defmethod timestamp-val ((m <BlackBoardAck>))
...
(cl:defmethod robot_id-val ((m <BlackBoardAck>))
  ...
  (robot_id m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BlackBoardAck>) ostream)
  "Serializes a message object of type '<BlackBoardAck>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BlackBoardAck>) istream)
  "Deserializes a message object of type '<BlackBoardAck>"
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BlackBoardAck>)))
  "Returns string type for a message object of type '<BlackBoardAck>"
  "gsdf_msgs/BlackBoardAck")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BlackBoardAck)))
  "Returns string type for a message object of type 'BlackBoardAck"
  "gsdf_msgs/BlackBoardAck")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BlackBoardAck>)))
  "Returns md5sum for a message object of type '<BlackBoardAck>"
  "21fe3110556151fb76fd0bddb9325f46")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BlackBoardAck)))
  "Returns md5sum for a message object of type 'BlackBoardAck"
  "21fe3110556151fb76fd0bddb9325f46")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BlackBoardAck>)))
  "Returns full string definition for message of type '<BlackBoardAck>"
  (cl:format cl:nil "int32 bb_id~%int32 on_robot_id~%string key~%uint8[] value~%time timestamp~%int32 robot_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BlackBoardAck)))
  "Returns full string definition for message of type 'BlackBoardAck"
  (cl:format cl:nil "int32 bb_id~%int32 on_robot_id~%string key~%uint8[] value~%time timestamp~%int32 robot_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <BlackBoardAck>))
  (cl:+ 0
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <BlackBoardAck>))
  "Converts a ROS message object to a list"
  (cl:list 'BlackBoardAck
