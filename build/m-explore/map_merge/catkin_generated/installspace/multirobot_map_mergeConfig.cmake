...
if("FALSE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/plankton/DDP/src/m-explore/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/plankton/DDP/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/plankton/DDP/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/plankton/DDP/install/${idir}'.  ${_report}")
    endif()
