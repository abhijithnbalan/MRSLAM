...
MultiMapper::MultiMapper()
{
	...
	robotNode.param("scan_input_topic", mScanInputTopic1, std::string("karto_in_1"));
    robotNode.param("scan_input_topic", mScanInputTopic2, std::string("karto_in_2"));
	...
	mScanSubscriber1 = robotNode.subscribe(mScanInputTopic1, 100, &MultiMapper::receiveLocalizedScan, this);
	mScanSubscriber2 = robotNode.subscribe(mScanInputTopic2, 100, &MultiMapper::receiveLocalizedScan, this);
